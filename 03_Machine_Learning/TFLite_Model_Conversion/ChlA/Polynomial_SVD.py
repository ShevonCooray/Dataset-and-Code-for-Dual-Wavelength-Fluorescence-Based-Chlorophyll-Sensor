...
# Extract polynomial coefficients for Chl-a
coefficients_chla = poly_model_chla.coef_
intercept_chla = poly_model_chla.intercept_

# Extract polynomial coefficients for Chl-b
coefficients_chlb = poly_model_chlb.coef_
intercept_chlb = poly_model_chlb.intercept_

print("Chl-a Polynomial Coefficients:", coefficients_chla)
print("Chl-a Intercept:", intercept_chla)

print("Chl-b Polynomial Coefficients:", coefficients_chlb)
print("Chl-b Intercept:", intercept_chlb)
