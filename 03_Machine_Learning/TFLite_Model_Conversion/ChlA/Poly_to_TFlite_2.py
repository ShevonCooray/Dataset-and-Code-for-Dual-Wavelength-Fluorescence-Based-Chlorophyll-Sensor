...
svd_chla = joblib.load("svd_chla.pkl")  # SVD Model
poly_transform = joblib.load("poly_transform.pkl")  # Polynomial Feature Transformer
linear_model_chla = joblib.load("poly_model_chla.pkl")  # Only LinearRegression, NOT a Pipeline
...
with open("chl_a_model.tflite", "wb") as f:
    f.write(tflite_model)

print("✅ Successfully converted and saved as `chl_a_model.tflite`!")
