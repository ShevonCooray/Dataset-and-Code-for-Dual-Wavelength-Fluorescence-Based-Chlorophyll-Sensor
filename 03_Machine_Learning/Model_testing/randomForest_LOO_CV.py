...
rmse_chla = np.sqrt(avg_mse_chla)
rmse_chlb = np.sqrt(avg_mse_chlb)
...
# Print summary
print(f"\n🌲 Chl-a - Mean Validation MSE: {avg_mse_chla:.6f} | Std Dev MSE: {std_mse_chla:.6f} | RMSE: {rmse_chla:.6f}")
print(f"🌲 Chl-b - Mean Validation MSE: {avg_mse_chlb:.6f} | Std Dev MSE: {std_mse_chlb:.6f} | RMSE: {rmse_chlb:.6f}")

print(f"\n🌲 Chl-a - Mean Validation RMSE: {avg_rmse_chla:.6f} | Std Dev RMSE: {std_rmse_chla:.6f} ")
print(f"🌲 Chl-b - Mean Validation RMSE: {avg_rmse_chlb:.6f} | Std Dev RMSE: {std_rmse_chlb:.6f} ")

print(f"\n🌲 Chl-a - R²: {r2_chla:.6f} | σ_residuals: {std_resid_chla:.6f}")
print(f"🌲 Chl-b - R²: {r2_chlb:.6f} | σ_residuals: {std_resid_chlb:.6f}")
...
plt.ylabel("MSE")
plt.title("Sample-wise MSE (LOO-CV) - Random Forest")
plt.legend()
plt.grid(True)
plt.show()
...
plt.title("Actual vs. Predicted Concentration - Random Forest")
plt.legend()
plt.grid(True)
plt.show()
